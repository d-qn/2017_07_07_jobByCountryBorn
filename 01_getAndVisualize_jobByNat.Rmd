...
plotProportionalStackedBar <- function(ddd, txt) {
  ...
  gp2 <- gp +  
    geom_segment(data = tibble(x = meanCH, xend = meanCH, y = 0, yend = 1), 
                 ...
                 linetype = 2, colour = "#efe9e0", size = 0.8, alpha = 0.7) +
    annotate(geom = "text", x = meanCH,  y = 1.02, 
             label = txt["average" , lang], vjust = 1, hjust = 0.5,
             family = "Open Sans Condensed", colour =  "#193442", size = 3) + 
  ...
  gpi <- ggiraph(
    ...
    tooltip_opacity = 0.8,
    tooltip_extra_css = "padding:4px;margin:2px;border-radius:2.5px;background-color:#efe9e0;font-size:1em;",
    tooltip_offx = -17,
    pointsize = 11,
    #width = 0.7,
    width_svg = 6,
